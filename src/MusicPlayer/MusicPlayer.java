...
public class MusicPlayer extends Application{
    ...
    public void start(Stage stage){
        ...
        File song = new File("./src/media/Perfect.mp3");
        String url = song.toURI().toString();
        Media media = new Media(url);
        MediaPlayer player = new MediaPlayer(media);
        MediaView mv = new MediaView(player);
        
        File song1 = new File("./src/media/Faded.mp3");
        ...
        Label description = new Label("Type in Faded or Perfect");
        ...
        play.setOnAction((javafx.event.ActionEvent event) -> {
            if(mediaName.getText().equalsIgnoreCase("Perfect")){
                player1.stop();
                player.play();
            
            }else if(mediaName.getText().equalsIgnoreCase("Faded")){
                player.stop();
                player1.play();
            }
        });
